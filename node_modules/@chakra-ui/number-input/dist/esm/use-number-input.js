...
import { ariaAttr, callAllHandlers, focus, isBrowser, isNull, maxSafeInteger, minSafeInteger } from "@chakra-ui/utils";
import { mergeRefs, normalizeEventKey, withFlushSync } from "@chakra-ui/react-utils";
...
export function useNumberInput(props) {
  ...
  var getInputProps = React.useCallback(function (props, ref) {
    ...
    return _extends({
      ...
      onFocus: callAllHandlers(props.onFocus, onFocusProp, withFlushSync(setFocused.on)),
