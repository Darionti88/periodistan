...
function useRadio(props) {
  ...
  var _props = props,
      ...
      value = _props.value,
      id = _props.id,
      htmlProps = _objectWithoutPropertiesLoose(_props, ["defaultIsChecked", "defaultChecked", "isChecked", "isFocusable", "isDisabled", "isReadOnly", "isRequired", "onChange", "isInvalid", "name", "value", "id"]);
  ...
  var getInputProps = (0, _react.useCallback)(function (props, forwardedRef) {
    ...
    var ownProps = (0, _utils.pick)(inputProps, ["id", "disabled", "readOnly", "required", "aria-invalid", "aria-required", "aria-readonly", "aria-describedby", "onFocus", "onBlur"]); // This is a workaround for React Concurrent Mode issue https://github.com/facebook/react/issues/18591. Remove once it's fixed.

    var focus = function focus() {
      if (typeof _reactDom["default"].flushSync === "function") {
        ;
    ...
    return _extends({}, props, ownProps, {
      ...
      onFocus: (0, _utils.callAllHandlers)(ownProps.onFocus, props.onFocus, focus),
