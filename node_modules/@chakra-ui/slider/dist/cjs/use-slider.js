...
function useSlider(props) {
  ...
  var onKeyDown = (0, _react.useCallback)(function (event) {
    var eventKey = (0, _reactUtils.normalizeEventKey)(event);
    var keyMap = {
  ...
  var onMouseDown = (0, _hooks.useCallbackRef)(function (event) {
    /**
  ...
  var onTouchStart = (0, _hooks.useCallbackRef)(function (event) {
