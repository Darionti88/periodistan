...
function useCheckboxGroup(props) {
  ...
  var handleChange = (0, _react.useCallback)(function (eventOrValue) {
    if (!value) return;
    var isChecked = (0, _reactUtils.isInputEvent)(eventOrValue) ? eventOrValue.target.checked : !value.includes(eventOrValue);
    var selectedValue = (0, _reactUtils.isInputEvent)(eventOrValue) ? eventOrValue.target.value : eventOrValue;
