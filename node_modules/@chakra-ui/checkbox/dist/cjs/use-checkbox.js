...
function useCheckbox(props) {
  ...
  var _props = props,
      ...
      htmlProps = _objectWithoutPropertiesLoose(_props, ["defaultIsChecked", "defaultChecked", "isChecked", "isFocusable", "isDisabled", "isReadOnly", "isRequired", "onChange", "isIndeterminate", "isInvalid", "name", "value", "id", "onBlur", "onFocus", "aria-label", "aria-labelledby", "aria-invalid", "aria-describedby"]);
  ...
  var getInputProps = (0, _react.useCallback)(function (props, forwardedRef) {
    ...
    return _extends({}, props, {
      ...
      onBlur: (0, _utils.callAllHandlers)(props.onBlur, setFocused.off, onBlurProp),
      onFocus: (0, _utils.callAllHandlers)(props.onFocus, (0, _reactUtils.withFlushSync)(setFocused.on), onFocusProp),
