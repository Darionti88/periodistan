...
function usePopover(props) {
  ...
  var arrowShadowColor = (0, _system.useToken)("colors", shadowColor, arrowShadowColorProp);
  ...
  (0, _hooks.useFocusOnPointerDown)({
    doc: _utils.isBrowser ? (0, _utils.getOwnerDocument)(triggerRef.current) : null,
    elements: [triggerRef]
  });
  ...
  var getPopoverProps = (0, _react.useCallback)(function (props, _ref) {
    ...
    var popoverProps = _extends({}, props, {
      ...
      onBlur: (0, _utils.callAllHandlers)(props.onBlur, function (event) {
        var relatedTarget = (0, _reactUtils.getRelatedTarget)(event);
  ...
  var getPopoverPositionerProps = (0, _react.useCallback)(function (props, _ref) {
    var _extends2;
    ...
    return _extends({}, props, {
      ref: (0, _reactUtils.mergeRefs)(popper.popperRef, _ref),
      style: _extends({}, props.style, (_extends2 = {}, _extends2[_popper.popperCSSVars.arrowSize["var"]] = arrowSize ? (0, _utils.px)(arrowSize) : undefined, _extends2[_popper.popperCSSVars.arrowShadowColor["var"]] = arrowShadowColor, _extends2.visibility = isOpen ? "visible" : "hidden", _extends2))
    });
  ...
  var getTriggerProps = (0, _react.useCallback)(function (props, _ref) {
    ...
    var triggerProps = _extends({}, props, {
      ref: (0, _reactUtils.mergeRefs)(triggerRef, _ref, popper.referenceRef),
      id: triggerId,
